                ...
                <div className="filtered-single-location">
                    <Grid container spacing={0}>
                        <Grid item xs={4}>
                            <Grid container spacing={0}>
                                <Grid item xs={12}>
                                    <img width="100%" height="200px" src={item.images[0]} alt="Granbell Hotel Colombo"/>
                                </Grid>
                                <Grid item xs={3}>
                                    <img width="100%" height="70px" src={item.images[1]} alt="Granbell Hotel Colombo"/>
                                </Grid>
                                <Grid item xs={3}>
                                    <img width="100%" height="70px" src={item.images[2]} alt="Granbell Hotel Colombo"/>
                                </Grid>
                                <Grid item xs={3}>
                                    <img width="100%" height="70px" src={item.images[3]} alt="Granbell Hotel Colombo"/>
                                </Grid>
                                <Grid item xs={3}>
                                    <img width="100%" height="70px" src={item.images[4]} alt="Granbell Hotel Colombo"/>
                                </Grid>
                            </Grid>
                        </Grid>
                        ...
                        <Grid item xs={2}>
                            <div className="filtered-location-review-price">
                                <Rating name="filtered-location-rating-stars" className="filtered-location-rating-stars"
                                        defaultValue={Math.round(item.rating / 2)} precision={0.5} readOnly/>
                                <Grid container spacing={0}>
                                    <Grid item xs={8}>
                                    ...
                                    <Grid item xs={4}>
                                        <div className="filtered-location-rating-flag">
                                            <p className="filtered-location-rating">
                                                {item.rating}
                                            </p>
                                        </div>
                                    </Grid>
                                ...
                                <div
                                    className={item.discount === 0 ? "filtered-location-discount hidden" : "filtered-location-discount"}>
                                    {Math.round(item.discount * 100)}% DISCOUNT
                                </div>
                                <div
                                    className={item.discount === 0 ? "filtered-location-price hidden" : "filtered-location-price"}>
                                    Rs. {item.price}.00
                                </div>
                                ...
                                <div className="filtered-location-people">
                                    2 Adults 1 Night
                                </div>
                                <Button fullWidth variant="contained" size="small">See Availability</Button>
                            </div>
                        </Grid>
                    </Grid>
                </div>
