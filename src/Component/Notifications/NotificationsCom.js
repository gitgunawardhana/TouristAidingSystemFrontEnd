...
import "./NotificationsCom.css"

function NotificationCom(){
    return(

    <div className="container  ">
        <div className="row row-margin-not">
            <div className="col-lg-3 left ">
                <div className="box shadow-sm mb-3 rounded bg-white ads-box text-center">
                    ...
                    <div className="p-3">
                        <button type="button" className="btn btn-outline-success btn-sm pl-4 pr-4">View settings
                        </button>
                    </div>
                </div>
                    ...
                    <div className="box-body p-0">
                        <div className="p-3 d-flex align-items-center bg-light border-bottom osahan-post-header">
                            ...
                            <div className="font-weight-bold mr-3">
                                ...
                                <div className="small">Income tax sops on the cards, The bias in VC funding, and other
                                    top news for you
                                </div>
                            </div>
                            <span className="ml-auto mb-auto">
                            <div className="btn-group">
                                <button type="button" className="btn btn-light btn-sm rounded" data-toggle="dropdown"
                ...
                <div className="box shadow-sm rounded bg-white mb-3">
                    ...
                    <div className="box-body p-0">
                        ...
                        <div className="p-3 d-flex align-items-center border-bottom osahan-post-header">
                            ...
                            <div className="font-weight-bold mr-3">
                                ...
                                <div className="small">Pellentesque semper ex diam, at tristique ipsum varius sed.
                                    Pellentesque non metus ullamcorper
                                </div>
                            </div>
                            <span className="ml-auto mb-auto">
                            <div className="btn-group">
                        ...
                        <div className="p-3 d-flex align-items-center border-bottom osahan-post-header">
                            ...
                            <div className="font-weight-bold mr-3">
                                <div className="mb-2"><span className="font-weight-normal">Congratulate Gurdeep Singh Osahan (iamgurdeeposahan)</span> for
                                    5 years at Askbootsrap Pvt.
                                </div>
                        ...
                        <div className="p-3 d-flex align-items-center border-bottom osahan-post-header">
                            ...
                            <div className="font-weight-bold mr-3">
                                <div>
                                    <span
                                        className="font-weight-normal">Congratulate Mnadeep singh (iamgurdeeposahan)</span> for
                                    4 years at Askbootsrap Pvt.
                                    <div className="small text-success"><i className="fa fa-check-circle"></i> You sent
                        ...
                        <div className="p-3 d-flex align-items-center border-bottom osahan-post-header">
                            <div
                                className="dropdown-list-image mr-3 d-flex align-items-center bg-success justify-content-center rounded-circle text-white">M
                            </div>
                            <div className="font-weight-bold mr-3">
                                <div className="text-truncate">DAILY RUNDOWN: MONDAY</div>
                                <div className="small">Nunc purus metus, aliquam vitae venenatis sit amet, porta non
                                    est.
                                </div>
                            </div>
                            <span className="ml-auto mb-auto">
